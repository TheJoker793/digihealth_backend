...
{
    public class PatientCreeConsumer : IConsumer<PatientCreeEvent>
    {
        private readonly SnapshotService _snapshotService;

        public PatientCreeConsumer(SnapshotService snapshotService)
            => _snapshotService = snapshotService;

        public async Task Consume(ConsumeContext<PatientCreeEvent> context)
        {
